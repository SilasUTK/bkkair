...
export const metadata: Metadata = {
  ...
  description:
    "ส่งคำขอเอกสารสนับสนุนวีซ่ากับ BKK AIR ง่ายแค่ 4 ขั้นตอน — เลือกแพ็กเกจ กรอกข้อมูล ทีมงานตรวจสอบ และรับ PDF สำหรับประกอบการยื่นวีซ่า",
};

const trustBadges = [
  "ตรวจสอบโดยทีมงานจริง",
  "แจ้งเวลาส่งหลังตรวจคำขอ",
...
const steps = [
  {
    ...
    body: "BKK AIR มีแพ็กเกจให้เลือกตามเอกสารสนับสนุนที่คุณต้องการ",
    bullets: [
  ...
  {
    number: "③",
    label: "ขั้นตอนที่ 3 — เจ้าหน้าที่แจ้งขั้นตอนถัดไป",
    title: "ทีมงานตรวจคำขอและแจ้งรายละเอียดก่อนดำเนินการ",
    ...
    bullets: [
      ...
      "หลังทีมงานตรวจสอบ คุณจะได้รับสรุปรายละเอียดคำขอและขั้นตอนถัดไป",
  ...
  },
  {
    ...
    title: "รับ PDF ทางอีเมลเพื่อใช้ประกอบแฟ้มเอกสาร",
...
const timeline = [
  ...
  ["หลังดำเนินการ", "รับ PDF ทางอีเมลเพื่อใช้ประกอบแฟ้มเอกสาร"],
...
const faqs = [
  ...
  [
    "BKK AIR ช่วยเตรียมเอกสารยื่นวีซ่าอย่างไร?",
    "BKK AIR ให้บริการเฉพาะการจัดเตรียมเอกสารสนับสนุน การอนุมัติวีซ่าเป็นดุลยพินิจของสถานทูตหรือสถานกงสุลในทุกกรณี และเราไม่มีความสัมพันธ์พิเศษกับสถานทูตใด ๆ",
  ],
];
...
const complianceDisclaimer =
  "BKK AIR ให้บริการเฉพาะการจัดเตรียมเอกสารสนับสนุนวีซ่าเท่านั้น เราไม่ใช่ตัวแทนวีซ่า ไม่มีความสัมพันธ์พิเศษกับสถานทูต และไม่มีส่วนในการตัดสินผลวีซ่า การอนุมัติวีซ่าเป็นดุลยพินิจของสถานทูตหรือสถานกงสุลในทุกกรณี";
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="mt-4 text-4xl font-black tracking-tight text-slate-900 sm:text-5xl lg:text-6xl">
              ไม่ซับซ้อน ไม่ต้องมีความรู้ด้านวีซ่า ส่งคำขอ รับการตรวจสอบ และรับ PDF สำหรับประกอบแฟ้มเอกสาร
            </h1>
            <p className="mx-auto mt-6 max-w-3xl text-lg leading-relaxed text-slate-600">
              BKK AIR ออกแบบกระบวนการให้ชัดเจน คุณแจ้งประเทศ วันเดินทาง และเอกสารที่ต้องการ จากนั้นทีมงานตรวจสอบก่อนดำเนินการ
            </p>
      ...
      <section className="bg-white px-6 py-16 md:py-24 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <h2 className="mt-3 text-3xl font-black tracking-tight text-slate-900 sm:text-4xl">
              ตั้งแต่ส่งคำขอจนได้รับเอกสาร ใช้เวลาเท่าไหร่?
            </h2>
          </div>
      ...
      <section className="bg-gradient-to-br from-[#F7FBFF] via-[#EEF6FF] to-[#FFF7F0] px-6 py-16 md:py-24 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg leading-relaxed text-slate-600">
            ใช้เวลาไม่นานในการกรอกข้อมูลเบื้องต้น จากนั้นทีมงานจะตรวจคำขอและแจ้งกรอบเวลาดำเนินการ
          </p>
