    ...
    <MarketingShell>
      <section className="bg-white px-6 py-16 lg:px-8 lg:py-24">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-2">
          <div>
            <p className="text-sm font-black uppercase tracking-widest text-[#2563EB]">Contact</p>
            ...
            <div className="mt-8 grid gap-4">
              ...
              <a href="mailto:info@bkkair.com" className="flex items-center gap-3 rounded-2xl border border-slate-100 bg-[#F8FAFC] p-5 font-bold text-slate-700"><Mail className="h-5 w-5 text-[#2563EB]" /> info@bkkair.com</a>
              ...
              <div className="flex items-center gap-3 rounded-2xl border border-slate-100 bg-[#F8FAFC] p-5 font-bold text-slate-700"><Clock className="h-5 w-5 text-[#FF5722]" /> เวลาทำการ: จันทร์-เสาร์ 09:00-18:00</div>
            </div>
          </div>
          ...
          <form className="rounded-[2rem] bg-[#F8FAFC] p-6 shadow-lg shadow-slate-200/50 sm:p-8">
            ...
            <div className="grid gap-5">
              ...
              <button type="button" className="rounded-2xl bg-[#FF5722] px-6 py-4 font-black text-white shadow-lg shadow-orange-200/60">ส่งข้อความถึงทีมงาน</button>
              <Link href="/order" className="text-center text-sm font-bold text-[#2563EB]">หรือส่งคำขอเอกสารที่ /order</Link>
            </div>
          </form>
        </div>
      </section>
